...
export type Person = {
	...
	location: string
	/** IANA time zone for live clock rendering */
...
/**
 * Tools hub page configuration.
 * @description Configuration for the Tools page, including metadata and navigation label.
 */
export interface ToolsHub extends BasePageConfig {}
